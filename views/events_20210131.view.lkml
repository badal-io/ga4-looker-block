...
view: events_20210131 {
  sql_table_name: `ld-snowplow.ga4_sample.events_20210131`
    ;;
...
view: events_20210131__items {
  ...
  dimension: events_20210131__items {
    type: string
    hidden: yes
    sql: events_20210131__items ;;
  }
...
view: events_20210131__event_params {
  dimension: events_20210131__event_params {
    type: string
    hidden: yes
    sql: events_20210131__event_params ;;
  }
...
view: events_20210131__user_properties {
  dimension: events_20210131__user_properties {
    type: string
    hidden: yes
    sql: events_20210131__user_properties ;;
  }
